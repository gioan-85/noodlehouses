...
var event_time = [
	// {public:'2020-12-24, 00:00:00', expire:'2020-12-26, 00:00:00'},
	// {public:'2021-12-24, 00:00:00', expire:'2021-12-26, 00:00:00'},
	{public:'2022-1-5, 00:00:00', expire:'2022-1-6, 00:00:00'}
]
...
$(document).ready(function(){	
	...
	$('#order_submit').bind('click', async function(){

		let ownerStopOrder = await OwnerStopOrder()
		let isStopOrderInEvent = stopOrderInEvent()

		if(ownerStopOrder == 0 || isStopOrderInEvent == true){
...
function stopOrderInEvent(){
	let stop_order = false
	event_time.forEach(time => {
		var start = new Date(time.public);
		var end = new Date(time.expire);
		stop_order = start.valueOf() <= today.valueOf() && today.valueOf() <= end.valueOf()
	});
	return stop_order
};

async function OwnerStopOrder() {
...
async function add_to_bill(id,name,price){
